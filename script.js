...
/******************************************************************************/
	...
	//ajout des noms animés à la liste des noms non-animés :
	//Array.prototype.push() ajoute un/des élément(s) à la fin d'un tableau.
	//apply() passe à la fonction des arguments sous forme de tableau
	Array.prototype.push.apply(nom, nomAnime);
	...
	var liste1 = [nomAnime, verbe, nom, complement];
...
/******************************************************************************/
	...
	function getRandomInt(min, max) {
	   ...
	   //Math.random() génère un nombre flottant aléatoire dans l'intervalle [0, 1[
	}
